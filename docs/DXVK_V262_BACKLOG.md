...
An independent default-off compute IAdd gate has host pipeline evidence and a
signed SDK-linked witness staged for 128-word readback; it has no GPU readback
