...
PROFILE = "t09-timeline-public-sdk-witness"
VALUES = 64
INITIAL_VALUE = 1000
GATE_VALUE = 1001
PHASE_VALUES = (1002, 1 << 40)
SEEDS = (0x5EED1001, 0x7A11E002)
...
def main() -> None:
    ...
    build = ROOT / "build/t09-timeline-witness"
    ...
    param.update(titleId="PPSA99994", conceptId="99994",
                 contentId="UP9000-PPSA99994_00-PS5VKTLS00000001")
    param["localizedParameters"]["en-US"]["titleName"] = (
        "PS5 Vulkan Timeline Semaphore Witness")
