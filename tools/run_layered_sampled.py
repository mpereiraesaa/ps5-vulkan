#!/usr/bin/env python3
"""Launch, verify and cleanly close one layered sampled-image PS5 run."""
import argparse
import json
from pathlib import Path

from run_consumer import close_and_confirm, control, running, wait_for_log
from verify_layered_sampled import TARGETS, validate
...
def main():
    ...
    try:
        ...
        result = validate(log.read_bytes(), receipt, artifact, args.target)
