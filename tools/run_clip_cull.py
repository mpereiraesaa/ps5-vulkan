#!/usr/bin/env python3
"""Launch, strictly verify and cleanly close one clip/cull witness run.
...
tools/verify_clip_cull.py, and closes the title again. Deployment identity is
...
from verify_clip_cull import validate
