"""Run one SDK-linked mirror-clamp draw and verify its GPU readback."""
import argparse
import json
...
try:
    ...
    from tools.verify_sampler_mirror import validate
except ModuleNotFoundError:
    from run_consumer import close_and_confirm, control, running, wait_for_log
    from verify_sampler_mirror import validate
