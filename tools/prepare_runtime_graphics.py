...
def main():
    ...
    modules = (
        ...
        ("experiments/graphics/runtime_sample_id.vert",
        ...
        ("experiments/graphics/runtime_subpass_resolve.frag",
         "runtime_subpass_resolve.frag.spv", "subpass_resolve_fragment"),
        ...
        ("experiments/graphics/runtime_gather_core.frag", "runtime_gather_core.frag.spv", "gather_core_fragment"),
        ("experiments/graphics/runtime_gather_const_offset.frag", "runtime_gather_const_offset.frag.spv", "gather_const_offset_fragment"),
        ("experiments/graphics/runtime_gather_dynamic_offset.frag", "runtime_gather_dynamic_offset.frag.spv", "gather_dynamic_offset_fragment"),
        ("experiments/graphics/runtime_gather_four_offsets.frag", "runtime_gather_four_offsets.frag.spv", "gather_four_offsets_fragment"),
        ("experiments/graphics/runtime_gather_component_0.frag", "runtime_gather_component_0.frag.spv", "gather_component_0_fragment"),
        ("experiments/graphics/runtime_gather_component_1.frag", "runtime_gather_component_1.frag.spv", "gather_component_1_fragment"),
        ("experiments/graphics/runtime_gather_component_2.frag", "runtime_gather_component_2.frag.spv", "gather_component_2_fragment"),
        ("experiments/graphics/runtime_gather_component_3.frag", "runtime_gather_component_3.frag.spv", "gather_component_3_fragment"),
        ("experiments/graphics/runtime_gather_dref.frag", "runtime_gather_dref.frag.spv", "gather_dref_fragment"),
