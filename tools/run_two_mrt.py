#!/usr/bin/env python3
"""Launch, strictly verify and retire one two-colour-target (independentBlend) PS5 probe run."""
import argparse
import json
...
try:
    ...
    from tools.verify_two_mrt import validate
except ModuleNotFoundError:
    from run_consumer import close_and_confirm, control, running, wait_for_log
    from verify_two_mrt import validate
