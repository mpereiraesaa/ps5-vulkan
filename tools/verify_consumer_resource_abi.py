...
def validate(log, receipt, artifact):
    ...
    if sampled is not None:
        ...
        require(sampled_profile in ("fragment", "vertex-fragment", "mixed-resources"),
        ...
        if sampled_profile == "mixed-resources":
            require(sampled.get("uniform_buffers") == 4 and
    ...
    mixed_profile = sampled is not None and sampled.get("stage_profile") == "mixed-resources"
    if mixed_profile:
        ...
        require(not sampled_rows and not mixed_rows,
