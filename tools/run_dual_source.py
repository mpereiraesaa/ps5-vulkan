#!/usr/bin/env python3
"""Launch, strictly verify and retire one dual-source blend PS5 probe run."""
import argparse
import json
...
try:
    ...
    from tools.verify_dual_source import validate
except ModuleNotFoundError:
    from run_consumer import close_and_confirm, control, running, wait_for_log
    from verify_dual_source import validate
