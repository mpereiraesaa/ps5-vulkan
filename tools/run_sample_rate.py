#!/usr/bin/env python3
"""Launch, strictly verify and retire one DXVK262-T06 sample-rate witness run."""
import argparse
import json
...
try:
    ...
    from tools.verify_sample_rate import validate
except ModuleNotFoundError:
    from run_consumer import close_and_confirm, control, running, wait_for_log
    from verify_sample_rate import validate
