#!/usr/bin/env python3
"""Launch, strictly verify and retire one input-attachment PS5 probe run."""
import argparse
import json
from pathlib import Path

from run_consumer import close_and_confirm, control, running, wait_for_log
from verify_input_attachment_probe import validate
...
def main():
    ...
    try:
        ...
        result = validate(log.with_suffix(""), args.manifest, args.artifact)
