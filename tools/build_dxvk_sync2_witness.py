...
from build_t09_timeline_witness import checked_spirv, expected_digest, run  # noqa: E402,F401
from lab import lab_root  # noqa: E402
from prepare_consumer_sync_shaders import emit_array  # noqa: E402

PROFILE = "dxvk-sync2-public-sdk-witness"
VALUES = 64
INITIAL_VALUE = 1000
GATE_VALUE = 1002
...
def main() -> None:
    ...
    build = ROOT / "build/dxvk-sync2-witness"
    ...
    # The diagnostic SDK build enumerates VK_KHR_synchronization2.
    ...
    source = ROOT / "examples/dxvk_sync2_witness/main.c"
    obj = build / "main.o"
    dep = build / "main.d"
    ...
    param.update(titleId="PPSA99994", conceptId="99994",
                 contentId="UP9000-PPSA99994_00-PS5VKSY200000001")
    param["localizedParameters"]["en-US"]["titleName"] = (
        "PS5 Vulkan Synchronization2 Witness")
    ...
    artifact = {
        ...
        "sdk_switches": dict(SDK_SWITCHES),
