"""Run, verify, and close the artifact-bound native ZPASS probe."""
import argparse
import json
...
try:
    ...
    from tools.verify_occlusion_probe import validate
except ModuleNotFoundError:
    from run_consumer import close_and_confirm, control, running, wait_for_log
    from verify_occlusion_probe import validate
