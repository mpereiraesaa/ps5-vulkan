...
/* VK_KHR_copy_commands2 needs VK_KHR_get_physical_device_properties2 on a
 * Vulkan 1.0 instance; vkCreateDevice enforces that. */
static VkBool32 copy_commands2_supported(VkPhysicalDevice p)
{
