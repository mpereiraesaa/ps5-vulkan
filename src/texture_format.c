...
static const struct ps5vk_texture_format formats[] = {
    ...
    {VK_FORMAT_B10G11R11_UFLOAT_PACK32,4, UINT32_C(0x02400000), {4,5,6,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16_UNORM,         2, UINT32_C(0x00700000), {4,0,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16_SNORM,         2, UINT32_C(0x00800000), {4,0,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16_SFLOAT,        2, UINT32_C(0x00d00000), {4,0,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16_UNORM,      4, UINT32_C(0x01700000), {4,5,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16_SNORM,      4, UINT32_C(0x01800000), {4,5,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16_SFLOAT,     4, UINT32_C(0x01d00000), {4,5,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16B16A16_UNORM,8,UINT32_C(0x04100000), {4,5,6,7}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16B16A16_SNORM,8,UINT32_C(0x04200000), {4,5,6,7}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R16G16B16A16_SFLOAT, 8, UINT32_C(0x04700000), {4,5,6,7}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R32_SFLOAT,        4, UINT32_C(0x01600000), {4,0,0,1}, VK_FALSE, VK_TRUE},
    {VK_FORMAT_R32G32_SFLOAT,     8, UINT32_C(0x04000000), {4,5,0,1}, VK_FALSE, VK_TRUE},
