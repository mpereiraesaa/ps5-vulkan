...
OBSERVED = {
    "vkEnumerateInstanceExtensionProperties": "Exists and is dispatched (GLOBAL). Enumerates VK_KHR_get_physical_device_properties2; a non-NULL layer name returns VK_ERROR_LAYER_NOT_PRESENT. Evidence: src/vk_device.c.",
    ...
    "vkEnumerateDeviceExtensionProperties": "Exists and is dispatched (INSTANCE). Enumerates VK_KHR_storage_buffer_storage_class, VK_KHR_8bit_storage and VK_KHR_16bit_storage when the platform exposes the corresponding storage-buffer features. Evidence: src/vk_device.c.",
    "vkCreateDevice": "Accepts only the enumerated narrow-storage extensions and exact supported feature structs; unsupported features, unknown chains and invalid booleans fail closed. Evidence: src/vk_device.c.",
    ...
    "vkGetPhysicalDeviceFeatures2KHR": "Reports storageBuffer8BitAccess and storageBuffer16BitAccess while leaving narrow arithmetic and other narrow storage classes false. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceProperties2KHR": "Returns the Vulkan 1.0 physical-device properties through the KHR properties2 structure. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceFormatProperties2KHR": "Delegates to the bounded core format report through VkFormatProperties2. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceImageFormatProperties2KHR": "Delegates validated image-format queries through the KHR structure pair. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceQueueFamilyProperties2KHR": "Reports the single queue family through VkQueueFamilyProperties2. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceMemoryProperties2KHR": "Reports the bounded memory profile through VkPhysicalDeviceMemoryProperties2. Evidence: src/vk_device.c.",
    "vkGetPhysicalDeviceSparseImageFormatProperties2KHR": "Returns an empty list because sparseBinding is not advertised. Evidence: src/vk_device.c.",
