#ifndef PS5VK_PS5VK_H
#define PS5VK_PS5VK_H
...
/*
 * PS5 Vulkan (ps5vk) Public SDK Header
 *
 ...
 * - Extension-negotiated storageBuffer8BitAccess/storageBuffer16BitAccess;
 *   narrow arithmetic and other 8/16-bit storage classes are not advertised
 */

#define PS5VK_SDK_VERSION_MAJOR 1
#define PS5VK_SDK_VERSION_MINOR 0
#define PS5VK_SDK_VERSION_PATCH 0

/* Standard Vulkan 1.0 Entry Points exported by ps5vk */
