...
* **Selected**: the 505 original upstream acceptance cases frozen in
  `cts/upstream/manifest.json`. This includes four standard UBO layout vertex
  oracles, seven VulkanKHR volatile storage-buffer atomic oracles, and the
  earlier API, graphics, compute, resource and synchronization cases. Two
  ...
  The manifest also carries 68 diagnostic paths, which remain outside strict
