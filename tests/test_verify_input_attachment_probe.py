...
RECORDS = [
    ...
    "PS5VK_COLOR_TO_TEXTURE_BARRIER serial=7 subpass=1 words=8",
    ...
    "PS5VK_INPUT_ATTACHMENT_COPY_COMPLETED source=tiled-color destination=linear-staging extent=64x64 layers=1",
    "PS5VK_INPUT_ATTACHMENT_READBACK extent=64x64 layers=6 view_layer=0 matched=4096 total=4096 verdict=ok first_x=0 first_y=0 first_word=ff00ff00 expected_first=ff00ff00 actual_hash=11223344 expected_hash=11223344 guard_words=4096 guard_mismatches=0 strict_verified=1",
...
class TestInputAttachmentProbeVerifier(unittest.TestCase):
    ...
    def test_rejects_each_material_contract_mutation(self):
        mutations = {
            ...
            "color_barrier": (3, "words=8", "words=7"),
            "boundary": (4, "subpass=1", "subpass=0"),
            "draw": (6, "draws=2", "draws=1"),
            "copy": (7, "source=tiled-color", "source=linear-color"),
            "pixels": (8, "matched=4096", "matched=4095"),
            "first": (8, "first_word=ff00ff00", "first_word=00000000"),
            "hash": (8, "actual_hash=11223344", "actual_hash=55667788"),
            "guard": (8, "guard_mismatches=0", "guard_mismatches=1"),
            "close": (9, "allocations_bytes=0", "allocations_bytes=64"),
        }
