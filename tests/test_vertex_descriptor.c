...
int main(void)
{
    ...
    const struct {uint64_t address,bytes;uint32_t stride,extent;} bad[]={
        {0,72,24,24},{3,72,24,24},{UINT64_C(1)<<48,72,24,24},
        {(UINT64_C(1)<<48)-4,72,24,24},{0x1000,0,24,24},
        {0x1000,23,24,24},{0x1000,72,0,24},{0x1000,72,25,24},
        {0x1000,72,0x4000,24},{0x1000,72,24,28},{0x1000,72,24,0},
        {0x1000,72,24,23},{0x1000,(UINT64_C(1)<<32)*24,24,24}};
