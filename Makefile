...
VK_QUEUE_SOURCES = $(VK_COMMAND_SOURCES) src/vk_fence.c src/vk_sync.c src/vk_buffer_transfer.c src/vk_query_pool.c src/vk_image_transfer.c src/color_clear.c src/vk_queue.c src/vk_queue_router.c
