...
| `src/texture_descriptor.c` | `src/gallium/ps5/ps5_screen.c`, texture resource descriptor construction | GFX10.3 2D, 2D-array, cube and 3D resource-type and dimension-field adaptation; ps5-vulkan supplies the Vulkan image/view validation and hardware readback gates |
